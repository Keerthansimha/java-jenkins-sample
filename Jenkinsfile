pipeline {
    ...
    environment {
        REMOTE_SERVER = '34.228.75.207'    // IP or hostname of the target server
            ...
            steps {
                sshagent(credentials: ['ssh-agent']) {
                    script {
                        ...
                        if (isUnix()) {
                            sh """
                               scp  -i /home/ubuntu/.ssh/id_ed25519 /opt/jenkins/workspace/testing-pipelne/target/jb-hello-world-maven-0.2.0.jar  ubuntu@ec2-34-228-75-207.compute-1.amazonaws.com:/var/www/html/myapp
